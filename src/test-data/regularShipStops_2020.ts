...
// Individual ship stop documents (2020)
export const regularShipStopGrandPrixFortLauderdale = {
...
export const regularShipStopGrandPrixPalmaDeMallorca = {
...
export const regularShipStopGrandPrixGenoa = {
...
export const regularShipStopSummerMedFortLauderdale = {
...
export const regularShipStopSummerMedPalmaDeMallorca = {
...
export const regularShipStopSummerMedGenoa = {
...
export const regularShipStopSummerMedFethiye = {
...
export const regularShipStopEuropeToAsiaHongKong = {
...
export const regularShipStopAsiaToNASummerVictoria = {
...
export const regularShipStopNAEastboundSummerEnsenada = {
...
export const regularShipStopNAEastboundSummerGolfito = {
...
export const regularShipStopNAEastboundSummerFortLauderdale = {
...
export const regularShipStopFtLauderdaleBoatShowGenoa = {
...
export const regularShipStopFtLauderdaleBoatShowPalmaDeMallorca = {
...
export const regularShipStopFtLauderdaleBoatShowFortLauderdale = {
...
export const regularShipStopChristmasGenoa = {
...
export const regularShipStopChristmasPalmaDeMallorca = {
...
export const regularShipStopChristmasTortola = {
...
export const regularShipStopWestboundNAAsiaChristmasFortLauderdale = {
...
export const regularShipStopWestboundNAAsiaChristmasGolfito = {
...
export const regularShipStopWestboundNAAsiaChristmasEnsenada = {
...
export const regularShipStopWestboundNAAsiaChristmasVictoria = {
...
export const regularShipStopWestboundNAAsiaChristmasHongKong = {
...
export const REGULAR_SHIP_STOPS_2020 = [
  regularShipStopGrandPrixFortLauderdale,
  regularShipStopGrandPrixPalmaDeMallorca,
  regularShipStopGrandPrixGenoa,
  ...
  regularShipStopEuropeToAsiaHongKong,
  regularShipStopAsiaToNASummerVictoria,
  regularShipStopNAEastboundSummerEnsenada,
  regularShipStopNAEastboundSummerGolfito,
  regularShipStopNAEastboundSummerFortLauderdale,
  regularShipStopFtLauderdaleBoatShowGenoa,
  regularShipStopFtLauderdaleBoatShowPalmaDeMallorca,
  regularShipStopFtLauderdaleBoatShowFortLauderdale,
  regularShipStopChristmasGenoa,
  regularShipStopChristmasPalmaDeMallorca,
  regularShipStopChristmasTortola,
  regularShipStopWestboundNAAsiaChristmasFortLauderdale,
  regularShipStopWestboundNAAsiaChristmasGolfito,
  regularShipStopWestboundNAAsiaChristmasEnsenada,
  regularShipStopWestboundNAAsiaChristmasVictoria,
  regularShipStopWestboundNAAsiaChristmasHongKong
];
