...
export const sailingFrontendFields = ['_id', 'name', 'isActive', 'createdAt', 'updatedAt'];

export interface SailingWithShipStopAndPortsFrontend extends SailingFrontend {
  shipStops: ShipStopWithPortFrontend[];
}

export const sailingWithShipStopAndPortsFrontendFields = [...sailingFrontendFields, 'shipStops'];
