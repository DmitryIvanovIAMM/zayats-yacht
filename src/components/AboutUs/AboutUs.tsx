  ...
  return (
    <>
      <Box style={textStyle}>
        ...
        <br />
        Welcome to Zayats Yacht Transport, your trusted partner in global yacht logistics and
        transportation services. At Zayats Yacht Transport, we specialize in providing safe,
        ...
        yacht transportation, Zayats Yacht Transport has grown to become a leading name in the
        ...
        <br />
        Zayats Yacht Transport offers a comprehensive range of services tailored to meet the unique
        ...
        <br />
        At Zayats Yacht Transport, we are committed to excellence. Our dedicated team works closely
        ...
        Zayats Yacht Transport is here to make your yacht transportation experience seamless and
